...
## Mandatory Test Gates (Governance)

Per [0.17 of 00.01-Standards-of-Development.md](00.01-Standards-of-Development.md#017-workflow-governance--reuse-first--test-gates),
every protection or intent workflow change must pass:

| Gate | Test File | What It Covers |
|------|-----------|----------------|
| Contract enforcement | `test_contract_enforcement.py` | No duplicate helpers, pipeline exists |
| Regression (visibility) | `test_state_visibility_regression.py` | GRP element code, state-only rows, summary/table parity |
| Helper equivalence | `test_terraform_helpers_equivalence.py` | Shared env, paths, state parsing |
| Pipeline consistency | `test_cross_page_pipeline_consistency.py` | Same artifacts across pages, intent persistence |
| Combination matrix | `test_action_protection_matrix.py` | All action/protection/drift combos |
| Intent key consistency | `test_intent_key_consistency.py` | Key format and lookup correctness |

---

## Navigation

- **Previous:** [Standards of Development](00.01-Standards-of-Development.md)
- **Next:** [Protection Workflow Implementation](02-Protection-Workflow-Implementation.md) *(to be created)*
- **Related:** [43.03-Unified-Protect-Adopt-Pipeline.md](43.03-Unified-Protect-Adopt-Pipeline.md) — **Unified pipeline PRD** (defines 7 test harnesses)
- **Related:** [docs/architecture/canonical-contracts.md](../docs/architecture/canonical-contracts.md) — Canonical workflow contracts
