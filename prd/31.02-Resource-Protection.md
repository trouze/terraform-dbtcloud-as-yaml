...
- All protection code must use the canonical contracts (reconcile source,
  generate pipeline, terraform helpers).
- Protection-related changes require passing the regression test suite
  (`test_state_visibility_regression.py`, `test_contract_enforcement.py`).
- New protection features must encode regression tests and guardrails.

---

## Navigation

- [43.03-Unified-Protect-Adopt-Pipeline.md](43.03-Unified-Protect-Adopt-Pipeline.md) — Unified pipeline
- [11.01-Protection-Workflow-Testing.md](11.01-Protection-Workflow-Testing.md) — Testing framework
- [00.01-Standards-of-Development.md](00.01-Standards-of-Development.md) — Development standards
